...
**Documentacion completa:** [manual_editor.md](manual_editor.md)

### Resumen de Funcionalidades

| Caracteristica | Descripcion |
|----------------|-------------|
| Canvas 64x64 | Preview pixelado con zoom ajustable |
| Herramientas | Select, DateTime, Text, Image, Rect, FillRect, Line |
| Colores | Conversion automatica a RGB565 |
| Import/Export | Compatible con Canvas Clockface JSON |
| Imagen de referencia | Cargar imagen para calcar |
| Preparar imagen | Recortar, ajustar y convertir a 64x64 |
