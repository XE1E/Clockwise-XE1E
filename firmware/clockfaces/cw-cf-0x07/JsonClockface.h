...
class JsonClockface : public IClockface
{
private:
...
public:
  ...
  void setupNightMode(CWDateTime *dateTime, uint16_t color) override;
  void update() override;
  void setBuiltinNightMode(bool enabled, uint16_t color = 0xF800) override;
  bool supportsNightMode() override { return true; }
};
